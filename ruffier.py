...
txt_nodata = '''
[b]нет данных для такого возраста[/b]'''
txt_res = [] 
txt_res.append('''[b]низкая[/b]. 
Срочно обратитесь к врачу!''')
txt_res.append('''[b]удовлетворительная[/b]. 
Обратитесь к врачу!''')
txt_res.append('''[b]средняя[/b]. 
Возможно, стоит дополнительно обследоваться у врача.''')
txt_res.append('[b]выше среднего[/b]')
txt_res.append('[b]высокая[/b]. Это не вам нужно обратиться к врачу, а врачам обратиться к вам.')
